...
mixin _$InvoiceState {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is InvoiceState);
  }
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case _Loading() when loading != null:
        return loading();
      case _Loaded() when loaded != null:
        return loaded(_that.allInvoices, _that.activeInvoices,
            _that.pendingInvoices, _that.currentInvoice, _that.searchQuery);
      case _Error() when error != null:
...
class _Loading implements InvoiceState {
  const _Loading();
...
class _Loaded implements InvoiceState {
  const _Loaded(
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._activeInvoices, _activeInvoices) &&
            const DeepCollectionEquality()
                .equals(other._pendingInvoices, _pendingInvoices) &&
...
class _Error implements InvoiceState {
