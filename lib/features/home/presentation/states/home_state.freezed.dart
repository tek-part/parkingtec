...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl({final List<Lot> lots = const []}) : _lots = lots;
...
abstract class _Loaded implements HomeState {
  const factory _Loaded({final List<Lot> lots}) = _$LoadedImpl;
