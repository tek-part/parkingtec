...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "activeInvoices":
            MessageLookupByLibrary.simpleMessage("الفواتير النشطة"),
        "additionalOptions":
            MessageLookupByLibrary.simpleMessage("خيارات إضافية"),
        ...
        "appSubtitle":
            MessageLookupByLibrary.simpleMessage("حلول الإيقاف الذكية"),
        ...
        "autoPrintOptions":
            MessageLookupByLibrary.simpleMessage("خيارات الطباعة التلقائية"),
        "availableDevices":
            MessageLookupByLibrary.simpleMessage("الأجهزة المتاحة"),
        "barcodeEnabled":
            MessageLookupByLibrary.simpleMessage("تفعيل الباركود"),
        "bluetoothPrintError":
            MessageLookupByLibrary.simpleMessage("خطأ في طباعة Bluetooth"),
        "bluetoothPrinterNotConnected":
            MessageLookupByLibrary.simpleMessage("طابعة Bluetooth غير متصلة"),
        "bluetoothTestPrintNotImplemented":
            MessageLookupByLibrary.simpleMessage(
        ...
        "carModelOptional":
            MessageLookupByLibrary.simpleMessage("موديل السيارة (اختياري)"),
        "carNumber": MessageLookupByLibrary.simpleMessage("رقم السيارة"),
        "carNumberRequired":
            MessageLookupByLibrary.simpleMessage("رقم السيارة مطلوب"),
        "carRequested": MessageLookupByLibrary.simpleMessage("تم طلب السيارة"),
        "checkingAuthentication":
            MessageLookupByLibrary.simpleMessage("جاري التحقق من المصادقة..."),
        ...
        "completeInvoice":
            MessageLookupByLibrary.simpleMessage("إكمال الفاتورة"),
        "completeWithQr": MessageLookupByLibrary.simpleMessage("إكمال بـ QR"),
        "completed": MessageLookupByLibrary.simpleMessage("مكتملة"),
        "completingInvoice":
            MessageLookupByLibrary.simpleMessage("جاري إكمال الفاتورة..."),
        "configError":
            MessageLookupByLibrary.simpleMessage("حدث خطأ في تحميل الإعدادات"),
        "configLoading":
            MessageLookupByLibrary.simpleMessage("جاري تحميل الإعدادات..."),
        "confirm": MessageLookupByLibrary.simpleMessage("تأكيد"),
        "confirmEndSession":
            MessageLookupByLibrary.simpleMessage("تأكيد إنهاء الجلسة"),
        "confirmLogout":
        ...
        "connectedDevice":
            MessageLookupByLibrary.simpleMessage("الجهاز المتصل"),
        "connectedPrinter":
        ...
        "connectionStatus":
            MessageLookupByLibrary.simpleMessage("حالة الاتصال"),
        "continueWithoutPrinting":
            MessageLookupByLibrary.simpleMessage("المتابعة بدون طباعة"),
        ...
        "customerNameOptional":
            MessageLookupByLibrary.simpleMessage("اسم العميل (اختياري)"),
        "dailyAlreadyOpen":
            MessageLookupByLibrary.simpleMessage("هناك يومية مفتوحة بالفعل"),
        "dailyStartedSuccess":
            MessageLookupByLibrary.simpleMessage("تم بدء اليومية بنجاح"),
        "dailyTerminatedSuccess":
            MessageLookupByLibrary.simpleMessage("تم إنهاء اليومية بنجاح"),
        "dark": MessageLookupByLibrary.simpleMessage("داكن"),
        "date": MessageLookupByLibrary.simpleMessage("التاريخ"),
        "defaultFixedPrice":
            MessageLookupByLibrary.simpleMessage("السعر الثابت الافتراضي"),
        "defaultHourlyRate":
            MessageLookupByLibrary.simpleMessage("سعر الساعة الافتراضي"),
        ...
        "endBalanceRequired":
            MessageLookupByLibrary.simpleMessage("رصيد النهاية مطلوب"),
        ...
        "endSessionDialogTitle":
            MessageLookupByLibrary.simpleMessage("إنهاء الجلسة اليومية"),
        "endSessionSuccess":
            MessageLookupByLibrary.simpleMessage("تم إنهاء الجلسة بنجاح"),
        "endTime": MessageLookupByLibrary.simpleMessage("وقت النهاية"),
        "endYourDailyShift":
            MessageLookupByLibrary.simpleMessage("إنهاء ورديتك اليومية"),
        "endingSession":
            MessageLookupByLibrary.simpleMessage("جاري إنهاء الجلسة النشطة..."),
        "enterAnyNotes":
            MessageLookupByLibrary.simpleMessage("أدخل أي ملاحظات..."),
        "enterCarNumber":
            MessageLookupByLibrary.simpleMessage("أدخل رقم السيارة"),
        "enterEndBalance":
            MessageLookupByLibrary.simpleMessage("أدخل الرصيد النهائي"),
        "enterNotes":
            MessageLookupByLibrary.simpleMessage("أدخل ملاحظات (اختياري)"),
        "error": MessageLookupByLibrary.simpleMessage("خطأ"),
        "errorTerminatingDaily":
            MessageLookupByLibrary.simpleMessage("خطأ في إنهاء الوردية"),
        "fieldRequired":
        ...
        "historyCleared":
            MessageLookupByLibrary.simpleMessage("تم مسح التاريخ"),
        ...
        "initializePrinter":
            MessageLookupByLibrary.simpleMessage("تهيئة الطابعة"),
        "invalidAmount": MessageLookupByLibrary.simpleMessage("مبلغ غير صحيح"),
        "invalidAmountFormat":
            MessageLookupByLibrary.simpleMessage("يرجى إدخال مبلغ صالح"),
        "invalidEndBalance":
            MessageLookupByLibrary.simpleMessage("يرجى إدخال رصيد نهاية صالح"),
        "invalidQrCode":
            MessageLookupByLibrary.simpleMessage("QR Code غير صحيح"),
        "invalidStartBalance":
            MessageLookupByLibrary.simpleMessage("يرجى إدخال رصيد بداية صالح"),
        "invoiceCompleted":
            MessageLookupByLibrary.simpleMessage("تم إكمال الفاتورة بنجاح"),
        "invoiceCompletedError":
            MessageLookupByLibrary.simpleMessage("خطأ في إكمال الفاتورة"),
        "invoiceCreatedSuccess":
            MessageLookupByLibrary.simpleMessage("تم إنشاء الفاتورة بنجاح"),
        "invoiceDataNotAvailable":
            MessageLookupByLibrary.simpleMessage("بيانات الإيصال غير متوفرة"),
        "invoiceDetails":
            MessageLookupByLibrary.simpleMessage("تفاصيل الفاتورة"),
        "invoiceError":
            MessageLookupByLibrary.simpleMessage("خطأ في تحميل الفواتير"),
        "invoiceHistory":
            MessageLookupByLibrary.simpleMessage("تاريخ الفواتير"),
        ...
        "invoiceNotFound":
            MessageLookupByLibrary.simpleMessage("الفاتورة غير موجودة"),
        "invoicePaid":
            MessageLookupByLibrary.simpleMessage("تم دفع الفاتورة بنجاح"),
        "invoicePaidError":
            MessageLookupByLibrary.simpleMessage("خطأ في دفع الفاتورة"),
        "invoicePickedUp":
            MessageLookupByLibrary.simpleMessage("تم استلام السيارة بنجاح"),
        "invoicePickedUpError":
            MessageLookupByLibrary.simpleMessage("خطأ في استلام السيارة"),
        "invoicePrintedSuccess":
            MessageLookupByLibrary.simpleMessage("تم طباعة الفاتورة بنجاح"),
        "invoiceRemoved":
            MessageLookupByLibrary.simpleMessage("تم إزالة الفاتورة"),
        ...
        "noActiveInvoices":
            MessageLookupByLibrary.simpleMessage("لا توجد فواتير نشطة"),
        "noConfigFound":
            MessageLookupByLibrary.simpleMessage("لم يتم العثور على الإعدادات"),
        "noInvoices": MessageLookupByLibrary.simpleMessage("لا توجد فواتير"),
        "noInvoicesFound":
            MessageLookupByLibrary.simpleMessage("لم يتم العثور على فواتير"),
        "noPendingInvoices":
            MessageLookupByLibrary.simpleMessage("لا توجد فواتير قيد الإحضار"),
        ...
        "openInBrowserSubtitle":
            MessageLookupByLibrary.simpleMessage("عرض في المتصفح الخارجي"),
        "optionalField":
        ...
        "pendingInvoices":
            MessageLookupByLibrary.simpleMessage("الفواتير قيد الإحضار"),
        "phoneNumber": MessageLookupByLibrary.simpleMessage("رقم الهاتف"),
        "pickupInvoice": MessageLookupByLibrary.simpleMessage("استلام السيارة"),
        "pleaseConnectToPrinterFirst":
            MessageLookupByLibrary.simpleMessage("يرجى الاتصال بطابعة أولاً"),
        "pleaseEnableBluetooth":
            MessageLookupByLibrary.simpleMessage("يرجى تفعيل البلوتوث"),
        "pleaseEnterEndBalance":
            MessageLookupByLibrary.simpleMessage("يرجى إدخال الرصيد النهائي"),
        "pleaseEnterPassword":
        ...
        "previewPdfSubtitle":
            MessageLookupByLibrary.simpleMessage("فتح في عارض PDF"),
        ...
        "printNativeOnSunmi":
            MessageLookupByLibrary.simpleMessage("طباعة Native على Sunmi"),
        "printNativeOnSunmiSubtitle":
            MessageLookupByLibrary.simpleMessage("طباعة إيصال مباشر بدون PDF"),
        "printOptions": MessageLookupByLibrary.simpleMessage("خيارات الطباعة"),
        "printPdf": MessageLookupByLibrary.simpleMessage("طباعة PDF"),
        "printPdfOnSunmi":
            MessageLookupByLibrary.simpleMessage("طباعة PDF على Sunmi"),
        ...
        "printSuccessful":
            MessageLookupByLibrary.simpleMessage("تم الطباعة بنجاح!"),
        "printerInitialized":
            MessageLookupByLibrary.simpleMessage("تم تهيئة الطابعة"),
        "printerNotConnected":
        ...
        "printerTypeEscPos":
            MessageLookupByLibrary.simpleMessage("ESC/POS Bluetooth"),
        ...
        "processingLogout":
            MessageLookupByLibrary.simpleMessage("جاري معالجة تسجيل الخروج..."),
        ...
        "reprintReceipt":
            MessageLookupByLibrary.simpleMessage("إعادة طباعة الإيصال"),
        "reprintTicket":
            MessageLookupByLibrary.simpleMessage("إعادة طباعة التذكرة"),
        ...
        "searchByCarNumber":
            MessageLookupByLibrary.simpleMessage("البحث برقم السيارة"),
        "searchingForPrinters":
            MessageLookupByLibrary.simpleMessage("جاري البحث عن الطابعات..."),
        "selectPrinterType":
            MessageLookupByLibrary.simpleMessage("اختر نوع الطابعة"),
        "sessionEndError":
            MessageLookupByLibrary.simpleMessage("خطأ في إنهاء الجلسة النشطة"),
        "settings": MessageLookupByLibrary.simpleMessage("الإعدادات"),
        "share": MessageLookupByLibrary.simpleMessage("مشاركة"),
        "shareSubtitle":
            MessageLookupByLibrary.simpleMessage("مشاركة عبر التطبيقات الأخرى"),
        ...
        "startBalanceRequired":
            MessageLookupByLibrary.simpleMessage("رصيد البداية مطلوب"),
        "startDaily": MessageLookupByLibrary.simpleMessage("بدء اليومية"),
        "startDailySession":
            MessageLookupByLibrary.simpleMessage("بدء جلسة اليومية"),
        ...
        "sunmiPrintError":
            MessageLookupByLibrary.simpleMessage("خطأ في طباعة Sunmi"),
        ...
        "terminateDailyAndLogout":
            MessageLookupByLibrary.simpleMessage("إنهاء الوردية والخروج"),
        "testPrint": MessageLookupByLibrary.simpleMessage("طباعة تجريبية"),
        "testPrintSuccess":
            MessageLookupByLibrary.simpleMessage("تمت الطباعة التجريبية بنجاح"),
        ...
        "userNotAuthenticated":
            MessageLookupByLibrary.simpleMessage("المستخدم غير مصرح له"),
